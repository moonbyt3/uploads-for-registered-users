...
if (get_option('users_can_register')) {
    ...
    function ufru_error_registration_disabled() {
        ...
        <div class="error notice">
            <p><?php _e( 'Error in plugin: <b>Uploads For Registrated Users</b>', 'uploads-for-registered-users' ); ?></p>
            <p><?php _e( '"Anyone can register" option is disabled in <a href="/wp-admin/options-general.php">Settings->General->Membership</a>. Please enable this option.', 'uploads-for-registered-users' ); ?></p>
        </div>
        <?php
    }
