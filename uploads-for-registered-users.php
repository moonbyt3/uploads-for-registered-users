...
if ( get_option( 'users_can_register' ) ) {
	...
	function custom_dashboard_scripts() {
		...
		wp_enqueue_script( 'ufru-admin-main-js', plugin_dir_url( __FILE__ ) . 'admin/js/main.js', [ 'jquery' ], '1.0', true );
	...
	require_once( plugin_dir_path( __FILE__ ) . '/admin/folder-scan.php' );
